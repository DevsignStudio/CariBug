...
export const Button3 = `<template>
    ...
    <veb-button class="primary-gradient" v-ripple>Button</veb-button>
    <veb-button class="accent-gradient" v-ripple>Button</veb-button>
