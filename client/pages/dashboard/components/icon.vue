            ...
            <div class="components-panel">
                <div class="components-panel-inner" style="width: 100%">
                    <div class="row center-xs">
                        <div class="col-xs-1" v-for="key in icons" :key="key" style="height: 48px;">
                            <div style="margin: 0 auto">
                                <veb-tooltip :text="key">
                                    <veb-icon trigger-tooltip :name="key" class="color-grey-600"></veb-icon>
                                </veb-tooltip>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-2"  style="height: 48px;">
                            <div class="button-center-container">
                                <a href="https://materialdesignicons.com/" target="_blank">
                                    <veb-button button-style="raised" class="primary" v-ripple v-elevation>View More</veb-button>
                                </a>
                            </div>
                        </div>
                    </div>
