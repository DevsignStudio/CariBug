<template>
    <div>
        ...
        <nuxt-link to="/dashboard/companies/" exact>
            <veb-nav-list><veb-icon name="domain"></veb-icon> Manage Company</veb-nav-list>
        </nuxt-link>
        <nuxt-link to="/dashboard/users/" exact>
            <veb-nav-list><veb-icon name="account-settings-variant"></veb-icon> Manage User</veb-nav-list>
        </nuxt-link>
